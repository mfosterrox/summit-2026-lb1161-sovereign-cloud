#!/bin/bash
#
# RHACS Monitoring Setup — single install script (certificates, COO/Perses stack, RHACS auth).
# YAMLs: cluster-observability-operator/, prometheus-operator/, perses/, rhacs/ (this directory).
#
